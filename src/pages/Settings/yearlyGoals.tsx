...
const YoyLabel: React.FunctionComponent<IYoyLabel> = (props) => {
  ...
  const value = bank.savingsYearHeaders.goals[year] - bank.savingsYearHeaders.goals[year-1]
        ...
        <Row key={year}>
          <Col sm={4} xs={8}>
            ...
            <div className="pull-right">
              <FireAmount extraClassName="label-fake-input" callback-props={['savingsYearHeaders', 'goals', year]} />
            </div>
          </Col>
